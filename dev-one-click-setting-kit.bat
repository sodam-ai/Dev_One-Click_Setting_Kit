...
:: ============================================================
:: πŸ¿Ã∫Íƒ⁄µ˘ »Ø∞Ê ≈∞∆Æ -- DEV-KIT.bat v1.5.1
:: AI πŸ¿Ã∫Íƒ⁄µ˘ ¿‘πÆ¿⁄∏¶ ¿ß«— ø¯≈¨∏Ø ∞≥πﬂ »Ø∞Ê ºº∆√ µµ±∏
:: ============================================================

:: ≥Ø¬• ∫Øºˆ (PowerShell∑Œ ∑Œƒ…¿œ µ∂∏≥¿˚ √≥∏Æ)
...
:: ∑Œ±◊ ∆ƒ¿œ √ ±‚»≠
> "%LOG_FILE%" echo === πŸ¿Ã∫Íƒ⁄µ˘ »Ø∞Ê ≈∞∆Æ º≥ƒ° ªÛºº ∑Œ±◊ ===
>> "%LOG_FILE%" echo Ω√¿€: %DATE% %TIME%
>> "%LOG_FILE%" echo.
...
echo.
echo  ===========================================================
echo    √≥¿Ω ø¿ºÃ≥™ø‰? 30√ ∏∏ ¿–æÓ¡÷ººø‰.
echo  ===========================================================
echo.
echo   - ¿Ã «¡∑Œ±◊∑•¿∫ ƒ⁄µ˘ø° « ø‰«— µµ±∏µÈ¿ª ¿⁄µø¿∏∑Œ º≥ƒ°«ÿ ¡›¥œ¥Ÿ.
echo   - π¯»£∏¶ ∞Ì∏£±‚ ¿¸ø°¥¬ æ∆π´∞Õµµ º≥ƒ°µ«¡ˆ æ ¿∏¥œ æ»Ω…«œººø‰.
echo   - º≥ƒ° ¡ﬂ ∆ƒ∂ı ∞Ê∞Ì√¢[Windows∞° PC∏¶ ∫∏»£«ﬂΩ¿¥œ¥Ÿ]¿Ã ∂∞µµ ¡§ªÛ¿‘¥œ¥Ÿ.
echo     ±◊∑≤ ∂© [√ﬂ∞° ¡§∫∏] ∏¶ ¥©∏• µ⁄ [Ω««‡] ¿ª ¥©∏£∏È µÀ¥œ¥Ÿ.
echo   - ¿Œ≈Õ≥›¿∏∑Œ πﬁ±‚ ∂ßπÆø° Ω√∞£¿Ã ¡ª ∞…∑¡µµ √¢¿ª ¥›¡ˆ ∏∂ººø‰.
echo   - √≥¿Ω¿Ã∂Û∏È ∏ﬁ¥∫ø°º≠ [A] ∞°¿Â Ω¨øÓ √ﬂ√µ º≥ƒ° ∏¶ ¥©∏£ººø‰.
echo.
echo   - ∏µÁ µµ±∏¥¬ ∫£≈∏∞° æ∆¥— 'æ»¡§ πˆ¿¸', NodeøÕ Java¥¬ 'LTS(ø¿∑° ¡ˆø¯µ«¥¬ æ»¿¸∆«)'∑Œ º≥ƒ°µÀ¥œ¥Ÿ.
pause
...
echo.
echo  ===========================================================
echo    [96mπŸ¿Ã∫Íƒ⁄µ˘ »Ø∞Ê ≈∞∆Æ ^| AI ∞≥πﬂ »Ø∞Ê ø¯≈¨∏Ø ºº∆√[0m
echo  ===========================================================
echo.
echo    [1] ø’√ ∫∏ º≥ƒ°    √≥¿Ω Ω√¿€«œ¥¬ ∫–  (5∞≥,  ~7∫–)
echo    [2] ¡ﬂ±ﬁ º≥ƒ°      æÓ¥¿ ¡§µµ Ω·∫ª ∫– (11∞≥, ~15∫–)
echo    [3] ∞Ì±ﬁ º≥ƒ°      æ€/º≠πˆ ∞≥πﬂ«œ¥¬ ∫–(16∞≥, ~35∫–)
echo    [4] ø√¿Œø¯ º≥ƒ°    ∏µÁ µµ±∏ º≥ƒ°    (18∞≥, ~45∫–)
echo    ---------------------------------------------------
echo    [5] º±≈√ º≥ƒ°      ø¯«œ¥¬ ∞Õ∏∏ ∞Ò∂Ûº≠
echo    [6] æ˜µ•¿Ã∆Æ       º≥ƒ°µ» µµ±∏ ¿¸√º √÷Ω≈¿∏∑Œ
echo    [7] ¡¶∞≈           µµ±∏ ªË¡¶ (∞≥∫∞/¿¸√º)
echo    [8] ¡˜¡¢ ¥ŸøÓ∑ŒµÂ  ∞¯Ωƒ ªÁ¿Ã∆Æ URL ∏Ò∑œ (winget ∫“∞° Ω√)
echo    [9] º≥ƒ° »Æ¿Œ      O/X + πˆ¿¸ ªÛ≈¬ «•Ω√
echo    [0] ¡æ∑·
echo.
echo  ===========================================================
echo    [A] ∞°¿Â Ω¨øÓ √ﬂ√µ º≥ƒ°   √≥¿Ω¿Ã∏È ¿Ã∞≈! (±‚∫ª 5¡æ + AI)
echo    [V] πˆ¿¸ º±≈√ º≥ƒ°        ∆Ø¡§ æ»¡§πˆ¿¸ (Python/Java/Ruby)
set /p MENU_CHOICE="  π¯»£∏¶ ¿‘∑¬«œººø‰: "
...
:: ============================================================
:: ªÁ¿¸ √º≈© (∞¯≈Î)
:: »£√‚ ¿¸ PRE_CHECK_RETURN ∫Øºˆø° ∫π±Õ ∑π¿Ã∫Ì º≥¡§
:: ============================================================
:PRE_CHECK
echo.
echo  [ªÁ¿¸ √º≈©] º≥ƒ° »Ø∞Ê¿ª »Æ¿Œ«’¥œ¥Ÿ...
echo.
>> "%LOG_FILE%" echo.
>> "%LOG_FILE%" echo === ªÁ¿¸ √º≈©: %TIME% ===

:: 1. Windows πˆ¿¸ »Æ¿Œ (∫ÙµÂ 19044 = Win10 21H2)
:: delims=. ¿∏∑Œ "10.0.22631.xxx" ¿« ºº π¯¬∞ ≈‰≈´(∫ÙµÂπ¯»£)∏∏ √ﬂ√‚
for /f "tokens=3 delims=." %%a in ('ver') do set WIN_BUILD=%%a
if defined WIN_BUILD (
    if !WIN_BUILD! LSS 19044 (
        echo  [¡÷¿«] Windows 10 ø¿∑°µ» πˆ¿¸ ∞®¡ˆ [∫ÙµÂ: !WIN_BUILD!]
        echo         winget ºˆµø º≥ƒ°: https://aka.ms/getwinget
        echo.
        >> "%LOG_FILE%" echo ¡÷¿«: Windows ∫ÙµÂ !WIN_BUILD! - winget ∫“æ»¡§ ∞°¥…
        set /p CONT_WIN="  ∞Ëº” ¡¯«‡«œΩ√∞⁄Ω¿¥œ±Ó? (Y/N): "
        if /i "!CONT_WIN!" NEQ "y" goto MAIN_MENU
    ) else (
        echo  [OK] Windows ∫ÙµÂ !WIN_BUILD!
        >> "%LOG_FILE%" echo OK: Windows ∫ÙµÂ !WIN_BUILD!
    )
)

:: 2. winget »Æ¿Œ
:: 2. winget »Æ¿Œ (ø©∑Ø ∞Ê∑Œ∑Œ ∞ﬂ∞Ì«œ∞‘ ∞®¡ˆ)
set "WINGET_OK="
winget --version >nul 2>&1 && set "WINGET_OK=1"
:: PATH ø°º≠ WindowsApps ∞° ∫¸¡≥¿ª ºˆ ¿÷¿∏¥œ ººº« PATH ø° √ﬂ∞° »ƒ ¿ÁΩ√µµ
...
if not defined WINGET_OK (
    echo.
    echo  [ø¿∑˘] winget[æ€ º≥ƒ° ∞¸∏Æ¿⁄]¿ª Ω««‡«“ ºˆ æ¯Ω¿¥œ¥Ÿ.
    echo.
    echo   [«ÿ∞· πÊπ˝ - æ∆∑° ¡ﬂ «œ≥™∏∏ «œ∏È µÀ¥œ¥Ÿ]
    echo.
    echo   πÊπ˝ 1. ¿Ã √¢¿ª ¥›∞Ì, ∏ﬁ¿Œ ∏ﬁ¥∫ø°º≠ [8] ¡˜¡¢ ¥ŸøÓ∑ŒµÂ ∑Œ
    echo           « ø‰«— µµ±∏∏¶ ∞¯Ωƒ ªÁ¿Ã∆Æø°º≠ πŸ∑Œ πﬁ¿∏Ω« ºˆ ¿÷Ω¿¥œ¥Ÿ.
    echo.
    echo   πÊπ˝ 2. Microsoft Store ø°º≠ "æ€ º≥ƒ° ∞¸∏Æ¿⁄" ∏¶ º≥ƒ°/æ˜µ•¿Ã∆Æ«— µ⁄
    echo           ¿Ã «¡∑Œ±◊∑•¿ª ¥ŸΩ√ Ω««‡«œººø‰.
    echo           [Ω∫≈‰æÓ ∏µ≈©] https://aka.ms/getwinget
    echo.
    echo   πÊπ˝ 3. º≥¡§ - æ€ - ∞Ì±ﬁ æ€ º≥¡§ - æ€ Ω««‡ ∫∞ƒ™ ø°º≠
    echo           "æ€ º≥ƒ° ∞¸∏Æ¿⁄" ∏¶ ƒ“ µ⁄ ¥ŸΩ√ Ω««‡«œººø‰.
    echo.
    >> "%LOG_FILE%" echo ø¿∑˘: winget Ω««‡ ∫“∞°
    pause
    goto MAIN_MENU
)
...
net session >nul 2>&1
if errorlevel 1 (
    echo  [æ»≥ª] ∞¸∏Æ¿⁄ ±««—¿Ã æ∆¥’¥œ¥Ÿ. ¥Î∫Œ∫– ±◊¥Î∑Œ º≥ƒ°µ«¡ˆ∏∏,
    echo         ¿œ∫Œ µµ±∏∞° æ» µ«∏È ¿Ã ∆ƒ¿œ¿ª ∏∂øÏΩ∫ øÏ≈¨∏Ø »ƒ "∞¸∏Æ¿⁄ ±««—¿∏∑Œ Ω««‡"¿ª ¥≠∑Ø∫∏ººø‰.
) else (
    echo  [OK] ∞¸∏Æ¿⁄ ±««—¿∏∑Œ Ω««‡ ¡ﬂ
)

:: 3. winget source update (Ω«∆–«ÿµµ ∞≠¡¶ ¡æ∑· ±›¡ˆ)
echo  [..] ∆–≈∞¡ˆ ∏Ò∑œ æ˜µ•¿Ã∆Æ ¡ﬂ... (√≥¿Ω Ω««‡ Ω√ 1~2∫–, ¿Ã»ƒ ∫¸∏ß)
winget source update >nul 2>&1
if errorlevel 1 (
    echo  [¡÷¿«] ∆–≈∞¡ˆ ∏Ò∑œ æ˜µ•¿Ã∆Æ Ω«∆– - ∞Ëº” ¡¯«‡«’¥œ¥Ÿ
    >> "%LOG_FILE%" echo ¡÷¿«: winget source update Ω«∆–
) else (
    echo  [OK] ∆–≈∞¡ˆ ∏Ò∑œ æ˜µ•¿Ã∆Æ øœ∑·
    >> "%LOG_FILE%" echo OK: winget source update º∫∞¯
)

:: 4. ¿Œ≈Õ≥› ø¨∞· »Æ¿Œ
ping -n 1 -w 3000 8.8.8.8 >nul 2>&1
if errorlevel 1 (
    echo  [¡÷¿«] ¿Œ≈Õ≥› ø¨∞·¿ª »Æ¿Œ«œººø‰.
    echo.
    >> "%LOG_FILE%" echo ¡÷¿«: ¿Œ≈Õ≥› ø¨∞· ∫“æ»¡§
    set /p CONT_NET="  ∞Ëº” ¡¯«‡«œΩ√∞⁄Ω¿¥œ±Ó? (Y/N): "
    if /i "!CONT_NET!" NEQ "y" goto MAIN_MENU
) else (
    echo  [OK] ¿Œ≈Õ≥› ø¨∞· »Æ¿Œ
    >> "%LOG_FILE%" echo OK: ¿Œ≈Õ≥› ø¨∞·
)
...
if errorlevel 1 (
    echo  [∞Ê∞Ì] CµÂ∂Û¿Ã∫Í ø©¿Ø ∞¯∞£ !DISK_MIN!GB πÃ∏∏ - º≥ƒ° ¡ﬂ Ω«∆–«“ ºˆ ¿÷Ω¿¥œ¥Ÿ.
    set /p CONT_DISK="  ∞Ëº”«œΩ√∞⁄Ω¿¥œ±Ó? (y/n): "
    if /i "!CONT_DISK!" NEQ "y" goto MAIN_MENU
) else (
    echo  [OK] µΩ∫≈© ø©¿Ø ∞¯∞£ »Æ¿Œ [!DISK_MIN!GB ¿ÃªÛ]
)
...
if not errorlevel 1 (
    for /f %%v in ('node --version 2^>nul') do (
        echo  [æ»≥ª] ±‚¡∏ Node.js %%v ∞®¡ˆ - ∞«≥ ∂‹ √≥∏ÆµÀ¥œ¥Ÿ
        >> "%LOG_FILE%" echo æ»≥ª: ±‚¡∏ Node.js %%v ∞®¡ˆ
    )
)
...
if not errorlevel 1 (
    for /f %%v in ('python --version 2^>nul') do (
        echo  [æ»≥ª] ±‚¡∏ Python %%v ∞®¡ˆ - ∞«≥ ∂‹ √≥∏ÆµÀ¥œ¥Ÿ
        >> "%LOG_FILE%" echo æ»≥ª: ±‚¡∏ Python %%v ∞®¡ˆ
    )
)

echo.
echo  [øœ∑·] ªÁ¿¸ √º≈© øœ∑·. º≥ƒ°∏¶ Ω√¿€«’¥œ¥Ÿ.
>> "%LOG_FILE%" echo ªÁ¿¸ √º≈© øœ∑·
timeout /t 2 >nul
set START_TIME=%TIME%
...
echo.
echo  --------------------------------------------------
echo  [ø’√ ∫∏ º≥ƒ° ∏Ò∑œ] 5∞≥ µµ±∏ (æ‡ 7∫– / µΩ∫≈© ~1GB)
echo    Git, Python 3, Node.js LTS, VS Code, Windows Terminal
echo  --------------------------------------------------
echo.
set /p CONFIRM_INST="  Y=º≥ƒ° Ω√¿€ / N=∏ﬁ¿Œ ∏ﬁ¥∫∑Œ: "
if /i "!CONFIRM_INST!" NEQ "y" goto MAIN_MENU
echo.
echo  ¿ÃπÃ º≥ƒ°µ» µµ±∏ √≥∏Æ πÊπ˝:
echo    [1] ∞«≥ ∂‹    («ˆ¿Á πˆ¿¸ ¿Ø¡ˆ)
echo    [2] æ˜±◊∑π¿ÃµÂ (√÷Ω≈ πˆ¿¸¿∏∑Œ)
echo    [3] ¡¶∞≈       (ªË¡¶∏∏)
set /p UPGRADE_CHOICE="  º±≈√ (±‚∫ª∞™=1): "
...
echo.
echo  --------------------------------------------------
echo  [¡ﬂ±ﬁ º≥ƒ° ∏Ò∑œ] 11∞≥ µµ±∏ (æ‡ 15∫– / µΩ∫≈© ~2GB)
...
echo.
echo  --------------------------------------------------
echo  [∞Ì±ﬁ º≥ƒ° ∏Ò∑œ] 16∞≥ µµ±∏ (æ‡ 35∫– / µΩ∫≈© ~6GB)
echo    ¡ﬂ±ﬁ ∆˜«‘ + Java 21 LTS, Flutter+Dart, Go, Rust
echo  --------------------------------------------------
echo.
set /p CONFIRM_INST="  Y=º≥ƒ° Ω√¿€ / N=∏ﬁ¿Œ ∏ﬁ¥∫∑Œ: "
if /i "!CONFIRM_INST!" NEQ "y" goto MAIN_MENU
...
echo.
echo  --------------------------------------------------
echo  [ø√¿Œø¯ º≥ƒ° ∏Ò∑œ] 18∞≥ µµ±∏ (æ‡ 45∫– / µΩ∫≈© ~7GB)
echo    ∞Ì±ﬁ ∆˜«‘ + Ruby, PHP
echo  --------------------------------------------------
echo.
set /p CONFIRM_INST="  Y=º≥ƒ° Ω√¿€ / N=∏ﬁ¿Œ ∏ﬁ¥∫∑Œ: "
...
cls
echo.
echo  [ø’√ ∫∏ º≥ƒ°] 5∞≥ µµ±∏∏¶ º≥ƒ°«’¥œ¥Ÿ.
echo.
>> "%LOG_FILE%" echo === ø’√ ∫∏ º≥ƒ° Ω√¿€: %TIME% ===

:: ¿«¡∏º∫ 1º¯¿ß: Git
call :INSTALL "Git" "Git.Git"
:: ¿«¡∏º∫ 2º¯¿ß: Python + Node.js
...
cls
echo.
echo  [¡ﬂ±ﬁ º≥ƒ°] 11∞≥ µµ±∏∏¶ º≥ƒ°«’¥œ¥Ÿ.
echo.
>> "%LOG_FILE%" echo === ¡ﬂ±ﬁ º≥ƒ° Ω√¿€: %TIME% ===
...
cls
echo.
echo  [∞Ì±ﬁ º≥ƒ°] 16∞≥ µµ±∏∏¶ º≥ƒ°«’¥œ¥Ÿ.
echo.
>> "%LOG_FILE%" echo === ∞Ì±ﬁ º≥ƒ° Ω√¿€: %TIME% ===
...
cls
echo.
echo  [ø√¿Œø¯ º≥ƒ°] 18∞≥ µµ±∏∏¶ º≥ƒ°«’¥œ¥Ÿ.
echo.
>> "%LOG_FILE%" echo === ø√¿Œø¯ º≥ƒ° Ω√¿€: %TIME% ===
...
if not errorlevel 1 (
    if "!UPGRADE_MODE!"=="upgrade" (
        ...
        echo         [æ˜±◊∑π¿ÃµÂ] %~1 [npm]
        >> "%LOG_FILE%" echo   ∞·∞˙: æ˜±◊∑π¿ÃµÂ [npm]
        >> "%REPORT_FILE%.tmp" echo   [æ˜±◊∑π¿ÃµÂ] %~1 [npm]
    ) else if "!UPGRADE_MODE!"=="remove" (
        npm uninstall -g %~2 >nul 2>&1
        echo         [¡¶∞≈] %~1 [npm]
        >> "%LOG_FILE%" echo   ∞·∞˙: ¡¶∞≈ [npm]
        >> "%REPORT_FILE%.tmp" echo   [¡¶∞≈] %~1 [npm]
    ) else (
        echo         [∞«≥ ∂‹] %~1 [¿ÃπÃ º≥ƒ°µ ]
        >> "%LOG_FILE%" echo   ∞·∞˙: ∞«≥ ∂‹ [¿ÃπÃ º≥ƒ°µ ]
        >> "%REPORT_FILE%.tmp" echo   [∞«≥ ∂‹] %~1 [npm]
    )
    goto :eof
)
...
if not errorlevel 1 (
    echo         [øœ∑·] %~1
    >> "%LOG_FILE%" echo   ∞·∞˙: º∫∞¯ [npm]
    >> "%REPORT_FILE%.tmp" echo   [º≥ƒ°] %~1 [npm]
    goto :eof
)
...
echo         [∞«≥ ∂‹] %~1 (npm º≥ƒ° Ω«∆–)
>> "%LOG_FILE%" echo   ∞·∞˙: Ω«∆– (npm)
>> "%REPORT_FILE%.tmp" echo   [Ω«∆–] %~1 (npm)
goto :eof

:INSTALL
set /a CURRENT+=1
echo  [!CURRENT!/!TOTAL!] %~1 º≥ƒ° ¡ﬂ...
>> "%LOG_FILE%" echo [!CURRENT!/!TOTAL!] %~2 Ω√¿€: %TIME%
...
if !INST_ERR! EQU 0 (
echo         [92m[øœ∑·][0m %~1
    >> "%LOG_FILE%" echo   ∞·∞˙: º∫∞¯ [errorlevel=0]
    set /a INSTALL_COUNT+=1
    >> "%REPORT_FILE%.tmp" echo   [º∫∞¯] %~1
    goto :eof
)

:: errorlevel 0¿Ã æ∆¥— ∞ÊøÏ ? winget list∑Œ ¿ÃπÃ º≥ƒ°µ  ø©∫Œ »Æ¿Œ
...
if not errorlevel 1 (
    if "!UPGRADE_MODE!"=="upgrade" (
        ...
        echo         [æ˜±◊∑π¿ÃµÂ] %~1
        >> "%LOG_FILE%" echo   ∞·∞˙: æ˜±◊∑π¿ÃµÂ [errorlevel=!INST_ERR!]
        set /a INSTALL_COUNT+=1
        >> "%REPORT_FILE%.tmp" echo   [æ˜±◊∑π¿ÃµÂ] %~1
    ) else if "!UPGRADE_MODE!"=="remove" (
        winget uninstall --id %~2 --source winget --silent >nul 2>&1
        echo         [¡¶∞≈] %~1
        >> "%LOG_FILE%" echo   ∞·∞˙: ¡¶∞≈
        set /a SKIP_COUNT+=1
        >> "%REPORT_FILE%.tmp" echo   [¡¶∞≈] %~1
    ) else (
        echo         [∞«≥ ∂‹] %~1 [¿ÃπÃ º≥ƒ°µ ]
        >> "%LOG_FILE%" echo   ∞·∞˙: ∞«≥ ∂‹ [¿ÃπÃ º≥ƒ°µ , errorlevel=!INST_ERR!]
        set /a SKIP_COUNT+=1
        >> "%REPORT_FILE%.tmp" echo   [∞«≥ ∂‹] %~1
    )
    goto :eof
...
:: Ω«¡¶ Ω«∆– ? 5√  »ƒ 1»∏ ¿⁄µø ¿ÁΩ√µµ
echo         [¿ÁΩ√µµ] %~1 Ω«∆– ? 5√  »ƒ ¿ÁΩ√µµ...
>> "%LOG_FILE%" echo   1¬˜ Ω«∆– (errorlevel=!INST_ERR!), ¿ÁΩ√µµ: %TIME%
timeout /t 5 /nobreak >nul
...
if !RETRY_ERR! EQU 0 (
echo         [92m[øœ∑·][0m %~1 [¿ÁΩ√µµ º∫∞¯]
    >> "%LOG_FILE%" echo   ¿ÁΩ√µµ º∫∞¯ [errorlevel=0]: %TIME%
    set /a INSTALL_COUNT+=1
    >> "%REPORT_FILE%.tmp" echo   [º∫∞¯] %~1 [¿ÁΩ√µµ]
    goto :eof
)
...
echo         [91m[∞«≥ ∂‹][0m %~1 º≥ƒ° Ω«∆– - ∞∆¡§∏∂ººø‰! ∏ﬁ¥∫ [8] ¡˜¡¢ ¥ŸøÓ∑ŒµÂø°º≠ πﬁ¿ª ºˆ ¿÷æÓø‰.
    >> "%LOG_FILE%" echo   ¿ÁΩ√µµ Ω«∆– [errorlevel=!RETRY_ERR!]: %TIME%
    set /a FAIL_COUNT+=1
    >> "%REPORT_FILE%.tmp" echo   [Ω«∆–] %~1
)
goto :eof

:: ============================================================
:: Post-install: ø’√ ∫∏ (Git autocrlf, pip æ˜±◊∑π¿ÃµÂ, npm fund)
:: ============================================================
:POST_BEGINNER
echo.
echo  ---------------------------------------------------
...
:: Git autocrlf ¿⁄µø º≥¡§ (Windows ¡ŸπŸ≤ﬁ «•¡ÿ, √π ƒøπ‘ ø¿∑˘ øππÊ)
where git >nul 2>&1
if not errorlevel 1 (
    git config --global core.autocrlf true >nul 2>&1
    >> "%LOG_FILE%" echo POST: git config --global core.autocrlf true øœ∑·
    echo  [¿⁄µø] Git ¡ŸπŸ≤ﬁ º≥¡§ øœ∑· [autocrlf=true]
    echo.
    echo  - Git ªÁøÎ¿⁄ ¡§∫∏¥¬ ¡˜¡¢ º≥¡§¿Ã « ø‰«’¥œ¥Ÿ:
    echo.
    echo      git config --global user.name  "»´±Êµø"
    echo      git config --global user.email "your@email.com"
    echo.
)

:: pip æ˜±◊∑π¿ÃµÂ ¿⁄µø Ω««‡ (pip ∞Ê∞Ì ¡¶∞≈)
where python >nul 2>&1
if not errorlevel 1 (
    python -m pip install --upgrade pip >nul 2>&1
    >> "%LOG_FILE%" echo POST: pip upgrade øœ∑·
    echo  [¿⁄µø] pip æ˜±◊∑π¿ÃµÂ øœ∑·
)
...
if not errorlevel 1 (
    ...
    >> "%LOG_FILE%" echo POST: npm config set fund false øœ∑·
    echo  [¿⁄µø] npm ±§∞Ì ∏ﬁΩ√¡ˆ ¡¶∞≈ øœ∑·
    echo  [AI « ºˆµµ±∏] Claude Code CLI º≥ƒ° ¡ﬂ...
    npm install -g @anthropic-ai/claude-code >nul 2>&1
    if not errorlevel 1 (
        >> "%LOG_FILE%" echo POST: Claude Code CLI º≥ƒ° º∫∞¯
        echo  [øœ∑·] Claude Code CLI º≥ƒ° øœ∑· - ªı ≈ÕπÃ≥Œø°º≠ claude --version
    ) else (
        >> "%LOG_FILE%" echo POST: Claude Code CLI º≥ƒ° Ω«∆–
        echo  [∞«≥ ∂‹] Claude Code CLI º≥ƒ° Ω«∆– - ¿Œ≈Õ≥› »Æ¿Œ »ƒ npm install -g @anthropic-ai/claude-code ∑Œ ¿ÁΩ√µµ
    )
)
echo.
goto :eof
...
:: ============================================================
:: Post-install: ¡ﬂ±ﬁ (Ollama ∏µ® æ»≥ª ? ¿⁄µø ¥ŸøÓ∑ŒµÂ ±›¡ˆ)
:: ============================================================
:POST_INTERMEDIATE
where ollama >nul 2>&1
if not errorlevel 1 (
    echo  - Ollama ∑Œƒ√ AI ∏µ® æ»≥ª [2GB ¿ÃªÛ ? ¡˜¡¢ Ω««‡]:
    echo.
    echo      ollama pull llama3.2   [æ‡ 2GB]
    echo      ollama pull gemma3     [æ‡ 3GB]
    echo.
)

echo  [¿⁄µø] πË∆˜/DB CLI µµ±∏ npm º≥ƒ° ¡ﬂ...
set /p INST_VERCEL="  Vercel CLI º≥ƒ°«“±Óø‰? (y/n): "
if /i "!INST_VERCEL!"=="y" call :NPM_INSTALL "Vercel CLI" "vercel"
set /p INST_SUPABASE="  Supabase CLI º≥ƒ°«“±Óø‰? (y/n): "
if /i "!INST_SUPABASE!"=="y" call :NPM_INSTALL "Supabase CLI" "supabase"
set /p INST_STRIPE="  Stripe SDK º≥ƒ°«“±Óø‰? (y/n): "
if /i "!INST_STRIPE!"=="y" call :NPM_INSTALL "Stripe SDK" "stripe"
set /p INST_RESEND="  Resend SDK º≥ƒ°«“±Óø‰? (y/n): "
if /i "!INST_RESEND!"=="y" call :NPM_INSTALL "Resend SDK" "resend"
goto :eof

:: ============================================================
:: Post-install: ∞Ì±ﬁ (Rust toolchain, VS Code »Æ¿Â URL æ»≥ª)
:: ============================================================
:POST_ADVANCED
where rustup >nul 2>&1
if not errorlevel 1 (
    rustup update stable >nul 2>&1
    >> "%LOG_FILE%" echo POST: rustup update stable øœ∑·
    echo  [¿⁄µø] Rust toolchain æ˜µ•¿Ã∆Æ øœ∑·
    echo.
)

echo  - VS Code »Æ¿Â «¡∑Œ±◊∑• (¡˜¡¢ º≥ƒ°):
echo.
...
echo  [¿⁄µø] ∞Ì±ﬁ πË∆˜ CLI º≥ƒ° ¡ﬂ...
call :NPM_INSTALL "Railway CLI" "@railway/cli"
goto :eof

:: ============================================================
:: ∏Æ∆˜∆Æ ª˝º∫ 2¡æ (ø‰æ‡ + ªÛºº)
:: ============================================================
:MAKE_REPORTS
set END_TIME=%TIME%
...
set /a _EM=_EL/60
set /a _EL_S=_EL %% 60
echo  º“ø‰ Ω√∞£: !_EM!∫– !_EL_S!√ 
>> "%LOG_FILE%" echo º“ø‰ Ω√∞£: !_EM!∫– !_EL_S!√ 

if not exist "%REPORT_FILE%.tmp" >> "%REPORT_FILE%.tmp" echo   (º≥ƒ° «◊∏Ò æ¯¿Ω)

:: ∞≠ªÁøÎ ø‰æ‡ ∏Æ∆˜∆Æ
(
    echo ====================================================
    echo  πŸ¿Ã∫Íƒ⁄µ˘ »Ø∞Ê ≈∞∆Æ - º≥ƒ° ∏Æ∆˜∆Æ
    echo ====================================================
    echo  PC ¿Ã∏ß:    %COMPUTERNAME%
    echo  º≥ƒ° ∑π∫ß:  %LEVEL_NAME%
    echo  º≥ƒ° ≥Ø¬•:  %DATE%
    echo  Ω√¿€ Ω√∞¢:  %START_TIME%
    echo  øœ∑· Ω√∞¢:  %END_TIME%
    echo  º∫∞¯: %INSTALL_COUNT%∞≥  ∞«≥ ∂‹: %SKIP_COUNT%∞≥  Ω«∆–: %FAIL_COUNT%∞≥
    echo ====================================================
    type "%REPORT_FILE%.tmp"
    echo ====================================================
    echo  ¿Ã ∆ƒ¿œ¿ª ∞≠ªÁø°∞‘ ¿¸¥ﬁ«œ∏È º≥ƒ° ªÛ≈¬∏¶ ∆ƒæ««“ ºˆ ¿÷Ω¿¥œ¥Ÿ.
    echo ====================================================
) > "%REPORT_FILE%"
...
>> "%LOG_FILE%" echo.
>> "%LOG_FILE%" echo === º≥ƒ° øœ∑·: %END_TIME% ===
>> "%LOG_FILE%" echo º∫∞¯: %INSTALL_COUNT% / ∞«≥ ∂‹: %SKIP_COUNT% / Ω«∆–: %FAIL_COUNT%

echo.
echo  [∏Æ∆˜∆Æ ¿˙¿Â øœ∑·] æ∆∑° ∆ƒ¿œ¿ª ∞≠ªÁø°∞‘ ¿¸¥ﬁ«ÿ ¡÷ººø‰:
echo    %REPORT_FILE%  (∞≠ªÁøÎ ø‰æ‡)
echo    %LOG_FILE%     (µπˆ±ÎøÎ ªÛºº)
goto :eof

:: ============================================================
:: PATH ∞À¡ı √‚∑¬ (º≥ƒ° øœ∑· »ƒ ¥´¿∏∑Œ »Æ¿Œ)
:: ============================================================
:PATH_CHECK
echo.
echo  ---------------------------------------------------
echo  [PATH ∞À¡ı] «ˆ¿Á ≈ÕπÃ≥Œø°º≠ ¿ŒΩƒµ«¥¬ µµ±∏
echo  ---------------------------------------------------
...
echo  ---------------------------------------------------
if !FAIL_COUNT! GTR 0 (
    echo  [¡÷¿«] ¿œ∫Œ µµ±∏ º≥ƒ° Ω«∆–: !FAIL_COUNT!∞≥
    echo         %LOG_FILE% ∏¶ ∞≠ªÁø°∞‘ ¿¸¥ﬁ«œººø‰.
    echo.
)
echo  º≥ƒ°∞° øœ∑·µ«æ˙Ω¿¥œ¥Ÿ!
echo.
echo  [¥Ÿ¿Ω ¥‹∞Ë ∞°¿ÃµÂ]
echo   1. ªı ≈ÕπÃ≥Œ ø≠±‚ (Ω√¿€∏ﬁ¥∫ -> Windows Terminal ∂«¥¬ PowerShell)
echo   2. git --version / python --version / node --version ¿‘∑¬ »Æ¿Œ
echo   3. git config --global user.name "»´±Êµø" «¸Ωƒ¿∏∑Œ ¿Ã∏ß º≥¡§
echo   4. git config --global user.email "my@email.com" «¸Ωƒ¿∏∑Œ ¿Ã∏ﬁ¿œ º≥¡§
echo   5. ∞¢ µµ±∏ º≥ƒ° »Æ¿Œ: [9] º≥ƒ° »Æ¿Œ ∏ﬁ¥∫ ¿ÃøÎ
echo.
echo  --- ¡÷ø‰ CLI πˆ¿¸ »Æ¿Œ ---
echo   vercel --version
...
echo.
echo  [πŸ¿Ã∫Íƒ⁄µ˘ √π ∞…¿Ω]
echo   1. Cursor ∂«¥¬ VS Code ∏¶ ø±¥œ¥Ÿ.
echo   2. Claude ø° ∑Œ±◊¿Œ«’¥œ¥Ÿ (Claude Desktop, ∂«¥¬ ≈ÕπÃ≥Œø°º≠ claude ∏Ì∑…).
echo   3. ªı ∆˙¥ı∏¶ ø≠∞Ì, ∏∏µÈ∞Ì ΩÕ¿∫ ∞Õ¿ª «—±πæÓ∑Œ ±◊¥Î∑Œ ¿˚æÓ∫∏ººø‰.
echo      øπ: ∞£¥‹«— ∏ﬁ∏ æ€ ∏∏µÈæÓ¡‡
echo.
echo.
echo  ªı ≈ÕπÃ≥Œ¿ª ø≠æÓº≠ Ω√¿€«œººø‰.
echo  («ˆ¿Á √¢¿∫ PATH ∫Ø∞Ê ¿¸ ªÛ≈¬¿‘¥œ¥Ÿ)
echo.
pause
goto :eof
...
echo.
echo  [∞°¿Â Ω¨øÓ √ﬂ√µ º≥ƒ°]
echo  √≥¿Ω Ω√¿€ø° « ø‰«— «ŸΩ… µµ±∏∏¶ «— π¯ø° º≥ƒ°«’¥œ¥Ÿ.
echo    - ±‚∫ª 5¡æ: Git, Python, Node.js, VS Code, Windows Terminal
echo    - AI: Claude Code[¿⁄µø º≥ƒ°]. Cursor / Claude Desktop ¿∫ ¥ŸøÓ∑ŒµÂ ∆‰¿Ã¡ˆ∏¶ ø±¥œ¥Ÿ(¡˜¡¢ º≥ƒ°).
echo.
set /p CONFIRM_EASY="  Y=º≥ƒ° Ω√¿€ / N=∏ﬁ¿Œ ∏ﬁ¥∫∑Œ: "
if /i "!CONFIRM_EASY!" NEQ "y" goto MAIN_MENU
set UPGRADE_MODE=skip
set LEVEL_NAME=√ﬂ√µº≥ƒ°
set DISK_MIN=3
set TOTAL=5
set CURRENT=0
set INSTALL_COUNT=0
...
cls
echo.
echo  [√ﬂ√µ º≥ƒ°] «ŸΩ… 5¡æ¿ª º≥ƒ°«’¥œ¥Ÿ.
echo.
>> "%LOG_FILE%" echo === √ﬂ√µ º≥ƒ° Ω√¿€: %TIME% ===
call :INSTALL "Git" "Git.Git"
call :INSTALL "Python 3" "Python.Python.3"
call :INSTALL "Node.js LTS" "OpenJS.NodeJS.LTS"
call :INSTALL "VS Code" "Microsoft.VisualStudioCode"
...
call :PATH_CHECK
echo.
echo  [æ»≥ª] AI µµ±∏¥¬ «¡∑Œ±◊∑•¿Ã∂Û ¡˜¡¢ º≥ƒ°∞° « ø‰«’¥œ¥Ÿ. ¥ŸøÓ∑ŒµÂ ∆‰¿Ã¡ˆ∏¶ ø±¥œ¥Ÿ...
echo    - Cursor(AI ƒ⁄µÂ ø°µ≈Õ) / Claude Desktop(AI √§∆√)
...
echo.
echo  ===================================================
echo   [ º±≈√ º≥ƒ° ]  π¯»£∏¶ Ω∞«•∑Œ ¿‘∑¬  (øπ: 1,3,6)
echo  ===================================================
echo.
echo   [ ±‚∫ª µµ±∏ ]   (√≥¿Ω¿Ã∏È [1]~[5] ±«¿Â)
...
echo  ---------------------------------------------------
set /p CONFIRM_SEL="  Y=º≥ƒ° Ω√¿€ / N=¥ŸΩ√ º±≈√: "
...
>> "%LOG_FILE%" echo.
>> "%LOG_FILE%" echo === º±≈√ º≥ƒ° ∏Ò∑œ: !SEL! ===

:: pnpm(8), Bun(10), npm µµ±∏(19-26) -> Node.js º±«‡ º≥ƒ°
set NEED_NODE=
...
if defined NEED_NODE (
    where node >nul 2>&1
    if errorlevel 1 (
        echo  [æ»≥ª] Node.js∞° « ø‰«’¥œ¥Ÿ. ∏’¿˙ º≥ƒ°«’¥œ¥Ÿ.
        set /a TOTAL+=1
        call :INSTALL "Node.js LTS" "OpenJS.NodeJS.LTS"
    )
)
...
:: Flutter(12) -> Java 21 º±«‡ º≥ƒ°
echo !SEL! | findstr /C:"12" >nul 2>&1
if not errorlevel 1 (
    where java >nul 2>&1
    if errorlevel 1 (
        echo  [æ»≥ª] Flutter¥¬ Java 21¿Ã « ø‰«’¥œ¥Ÿ. ∏’¿˙ º≥ƒ°«’¥œ¥Ÿ.
        set /a TOTAL+=1
        call :INSTALL "Java 21 LTS" "EclipseAdoptium.Temurin.21.JDK"
    )
)
...
cls
echo.
echo  [πˆ¿¸ º±≈√ º≥ƒ°] ∆Ø¡§ æ»¡§(LTS) πˆ¿¸¿ª ∞Ò∂Û º≥ƒ°«’¥œ¥Ÿ.
echo  ¿ﬂ ∏∏£∞⁄¿∏∏È [0]¿∏∑Œ µπæ∆∞° [1] ø’√ ∫∏ ∂«¥¬ [A] √ﬂ√µ º≥ƒ°∏¶ æ≤ººø‰.
echo  ---------------------------------------------------
echo    [1] Python      [2] Java(JDK)      [3] Ruby
echo    [0] ∏ﬁ¿Œ ∏ﬁ¥∫∑Œ
echo.
set /p VER_LANG="  ææÓ π¯»£: "
...
:VER_JAVA
echo.
echo  [Java(JDK) πˆ¿¸] ¿¸∫Œ LTS - ¿ﬂ ∏∏£∏È ±◊≥… Enter
echo    [1] 21(±«¿Â)    [2] 17    [3] 11    [4] 8
set /p JV="  º±≈√ (±‚∫ª=21 LTS): "
...
cls
echo.
echo  [πˆ¿¸ º±≈√ º≥ƒ°] !VER_NAME! : !VER_ID! ∏¶ º≥ƒ°«’¥œ¥Ÿ.
echo.
>> "%LOG_FILE%" echo === πˆ¿¸º±≈√ º≥ƒ°: !VER_ID! : %TIME% ===
...
cls
echo.
echo  [æ»¿¸ æ˜µ•¿Ã∆Æ] ∫£≈∏∞° æ∆¥— 'æ»¡§(LTS)' πˆ¿¸¿∏∑Œ∏∏ ¡°∞À«œ∞Ì æ˜µ•¿Ã∆Æ«’¥œ¥Ÿ.
echo.
>> "%LOG_FILE%" echo === ¿¸√º æ˜µ•¿Ã∆Æ Ω√¿€: %TIME% ===

echo  (NodeøÕ Java¥¬ LTS ∂Û¿Œ æ»ø°º≠∏∏ ø√∂Û∞°∏Á, ¿Ã ≈∞∆Æ∞° º≥ƒ°«— µµ±∏∏∏ ¥ÎªÛ¿‘¥œ¥Ÿ.)
echo.
echo  [»Æ¿Œ] ¬¸∞Ì∑Œ, ¡ˆ±› æ˜µ•¿Ã∆Æ ∞°¥…«— ¿¸√º ∏Ò∑œ¿‘¥œ¥Ÿ...
winget upgrade --source winget
echo.
set /p DO_UPD="  ≈∞∆Æ µµ±∏∏¶ æ»¿¸«œ∞‘ æ˜µ•¿Ã∆Æ«“±Óø‰? (y/n): "
...
for %%p in (Git.Git GitHub.GitLFS Python.Python.3 OpenJS.NodeJS.LTS GitHub.cli Microsoft.PowerShell pnpm.pnpm Oven-sh.Bun Ollama.Ollama Microsoft.VisualStudioCode Microsoft.WindowsTerminal EclipseAdoptium.Temurin.21.JDK GoLang.Go Rustlang.Rustup Google.FlutterSDK Stripe.StripeCLI RubyInstallerTeam.RubyWithDevKit.3.3 PHP.PHP EclipseAdoptium.Temurin.17.JDK EclipseAdoptium.Temurin.11.JDK EclipseAdoptium.Temurin.8.JDK Python.Python.3.13 Python.Python.3.12 Python.Python.3.11 RubyInstallerTeam.RubyWithDevKit.3.2) do (
    ...
    if not errorlevel 1 echo  [æ˜±◊∑π¿ÃµÂ] %%p
)

>> "%LOG_FILE%" echo ¿¸√º æ˜µ•¿Ã∆Æ øœ∑·: %TIME%
echo.
echo  [øœ∑·] æ˜µ•¿Ã∆Æ øœ∑·.
pause
goto MAIN_MENU
...
:REMOVE_ALL
echo.
echo  [∞Ê∞Ì] ¿Ã ≈∞∆Æ∑Œ º≥ƒ°«— ∏µÁ µµ±∏∏¶ ¡¶∞≈«’¥œ¥Ÿ.
set /p REM_ALL_CONFIRM="  Y∏¶ ¿‘∑¬«œ∏È ¡¯«‡«’¥œ¥Ÿ: "
...
:: ============================================================
:: ºˆµø º≥ƒ° æ»≥ª (Cursor √÷øÏº±)
:: ============================================================
:DO_MANUAL
cls
echo.
echo  [¡˜¡¢ ¥ŸøÓ∑ŒµÂ ∏µ≈©]
echo  - AI ƒ⁄µ˘ ø°µ≈Õ [17] Cursor ∏¶ ∞°¿Â ∏’¿˙ º≥ƒ°«œ¥¬ ∞Õ¿ª √ﬂ√µ«’¥œ¥Ÿ.
echo  winget º≥ƒ°∞° æ» µ… ∂ß ∞¯Ωƒ ªÁ¿Ã∆Æø°º≠ ¡˜¡¢ πﬁ¿∏ººø‰.
echo  ---------------------------------------------------
echo  π¯»£∏¶ ¿‘∑¬«œ∞≈≥™, URL ¿ßø°º≠ Ctrl+≈¨∏Ø «œ∏È ∫Í∂ÛøÏ¿˙ø°º≠ ø≠∏≥¥œ¥Ÿ.
echo.
echo   --- ø’√ ∫∏ µµ±∏ ---
...
if "!_OPENED!"=="1" echo. & echo  ∫Í∂ÛøÏ¿˙∞° ø≠∑»Ω¿¥œ¥Ÿ. ¥ŸøÓ∑ŒµÂ »ƒ º≥ƒ°«œººø‰. & echo. & pause
goto DO_MANUAL
:: ============================================================
:: º≥ƒ° ªÛ≈¬ »Æ¿Œ (O/X)
:: ============================================================
...
echo.
echo  ---------------------------------------------------
echo  ªı ≈ÕπÃ≥Œø°º≠ »Æ¿Œ Ω√ ¥ı ¡§»Æ«— ∞·∞˙∞° ≥™ø…¥œ¥Ÿ.
pause
goto MAIN_MENU
...
:DO_EXIT
echo.
echo  πŸ¿Ã∫Íƒ⁄µ˘ »Ø∞Ê ≈∞∆Æ∏¶ ¡æ∑·«’¥œ¥Ÿ.
echo  ¡¡¿∫ πŸ¿Ã∫Íƒ⁄µ˘ µ«ººø‰!
echo.
pause
exit /b 0
