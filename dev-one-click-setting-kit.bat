...
if not errorlevel 1 (
    ...
    >> "%LOG_FILE%" echo POST: Claude Code CLI º≥ƒ° øœ∑·
    echo  [¿⁄µø] Claude Code CLI º≥ƒ° øœ∑· (ªı ≈ÕπÃ≥Œ: claude --version)
...
cls
echo.
echo  [º±≈√ º≥ƒ°] ø¯«œ¥¬ π¯»£∏¶ Ω∞«•∑Œ ¿‘∑¬«œººø‰  (øπ: 1,3,6)
echo  ---------------------------------------------------
echo.
echo  [ ±‚∫ª µµ±∏ ]
...
echo         * 24=Supabase Auth ªÁøÎΩ√ ∫“« ø‰  25=DB ORM  26=∆ƒ¿œæ˜∑ŒµÂ
echo.
echo  [ Python µµ±∏ (winget) ]
echo    [27] uv (Python ∆–≈∞¡ˆ ∞¸∏Æ µµ±∏)
echo.
echo  ---------------------------------------------------
echo    0 = ∏ﬁ¿Œ ∏ﬁ¥∫∑Œ
echo.
